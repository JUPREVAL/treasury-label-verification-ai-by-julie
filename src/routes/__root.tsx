...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TTB Label Verification" },
      { name: "twitter:title", content: "TTB Label Verification" },
      { property: "og:description", content: "AI-powered alcohol beverage label verification prototype." },
      { name: "twitter:description", content: "AI-powered alcohol beverage label verification prototype." },
